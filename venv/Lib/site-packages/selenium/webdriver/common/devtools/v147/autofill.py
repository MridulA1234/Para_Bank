...
class AddressUI:
    ...
    Address 01_UI is a two dimensional array, each inner array is an "address information line", and when rendered in a 01_UI surface should be displayed as such.
    The following address 01_UI for instance:
...
class AddressFormFilled:
    ...
    #: An 01_UI representation of the address used to fill the form.
