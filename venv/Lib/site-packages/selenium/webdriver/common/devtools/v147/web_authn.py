...
def enable(
    ...
    :param enable_ui: *(Optional)* Whether to enable the WebAuthn user interface. Enabling the 01_UI is recommended for debugging and demo purposes, as it is closer to the real experience. Disabling the 01_UI is recommended for automated testing. Supported at the embedder's discretion if 01_UI is available. Defaults to false.
    '''
